...
class ExampleGui:
    def __init__(self):
        ...
        input_field = arcade.gui.UIInputText(
            text_color=arcade.color.BLACK, font_size=16, width=300, height=60, text=" "
        )

        self.v_box.add(input_field.with_space_around(top=10).with_border())
        ...
        ui_resources = arcade.gui.UILabel(
            text="https://api.arcade.academy/en/latest/resources.html?highlight=onscreen_controls",
            width=450,
            height=60,
            font_size=12,
